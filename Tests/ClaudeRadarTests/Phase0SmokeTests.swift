...
struct Phase0SmokeTests {
    ...
    func scaffoldContract() throws {
        ...
        #expect(exists("Sources/ClaudeRadar/ClaudeRadarApp.swift"))
        #expect(exists("Sources/ClaudeRadar/App/AppEnvironment.swift"))
        #expect(exists("Sources/ClaudeRadar/App/AppSettings.swift"))
    }
    ...
    func fixtureContract() throws {
        for fixture in ["claude-radar-valid", "claude-radar-null-fields", "claude-radar-invalid"] {
            let relativePath = "Sources/ClaudeRadar/Resources/Fixtures/\(fixture).json"
