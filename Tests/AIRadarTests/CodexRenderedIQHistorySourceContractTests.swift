...
struct CodexRenderedIQHistorySourceContractTests {
    ...
    private func fixture(_ name: String) throws -> Data {
        try Data(contentsOf: root.appending(path: "Tests/AIRadarTests/Fixtures/CodexRenderedIQHistory/\(name).json"))
    }
    ...
    private func checksumManifest() throws -> [String: String] {
        let content = try String(
            contentsOf: root.appending(path: "Tests/AIRadarTests/Fixtures/CodexRenderedIQHistory/SHA256SUMS"),
            encoding: .utf8
        )
