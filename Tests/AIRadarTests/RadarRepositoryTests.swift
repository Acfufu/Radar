...
struct RadarRepositoryTests {
    ...
    private func radarInsights(sourceID: RadarSourceID) -> RadarInsightsDataset {
    ...
    private func visualSpatialReasoning(sourceID: RadarSourceID) -> VisualSpatialReasoningDataset {
