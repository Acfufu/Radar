...
On 2026-07-16, the project owner authorized this app's automatic synchronization, local history caching, and re-display of Codex Radar's public summary and community responses. Codex Radar's public summary separately states that full JSON API access requires authorization; the app does not call or bypass the protected full API.
