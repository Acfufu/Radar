...
struct OverviewView: View {
    ...
    @State private var codexIQChartSource: CodexRenderedIQHistoryChartSource = .official24h
    @State private var officialIQSelection: CodexRenderedIQHistoryPresentation.Selection = .aggregate
    ...
    private var localTrendChart: some View {
